...
class AuthenticationAPI {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return Navigator.push(context,
            CustomSimplePageRoute(page: OtpPage(), routeName: otppage));
      }
    } on DioError catch (e) {
  ...
  postOtpVerification(
    ...
    FormData data = new FormData.fromMap({"otp": otp, "code": code});
  ...
  postRegisterUser(
    ...
    FormData data =
        new FormData.fromMap({"number": phonenumber, "name": userName});
