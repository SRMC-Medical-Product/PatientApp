       ...
       children: [
        ...
        Container(
          ...
          child: Column(
            ...
            mainAxisAlignment: MainAxisAlignment.start,
            children: [
              titleText(context: context, text: "Appointments for today", color: Colors.black.withOpacity(0.7)),
              mediumCustomSizedBox(context),
         ...
         ///Carousel
              Container(
                width: size.width,
               height: isMobile(context) ? size.height / 2.9 : size.height / 2.8,
                decoration: BoxDecoration(
                  color: kPrimaryColor,
                ),
                child: Column(
          ...
          horizontal: kDefaultScreenPaddingHorizontal(context),
          vertical: kDefaultScreenPaddingVertical(context)),
                      child: titleText(context: context, text: "Best of us", color: Colors.white),
                    ), 
