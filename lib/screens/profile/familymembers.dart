        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                                            onTap: () => Navigator.push(context, CustomSimplePageRoute(page: const AddNewMemberPage(), routeName: addnewmemberpage)),
                                            child: Container(
                                              height: 35, 
                  ...
                  itemBuilder: (BuildContext context, int i){
                    return Column(
                      ...
                      children: [
                        smallCustomSizedBox(context), 
                        ListTile(
                          onTap: () => Navigator.push(context, CustomSimplePageRoute(page: const EditFamilyMembersPage(), routeName: editfamilymemberspage)),
