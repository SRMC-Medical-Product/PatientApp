          ...
          child: FutureBuilder(
            ...
            builder: (BuildContext context, AsyncSnapshot snapshot){
              if(snapshot.hasData){
                ...
                Map<dynamic , dynamic > department = snapshot.data['departments'];
                return Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    GridView.builder(
                        ...
                        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                            ...
                            crossAxisSpacing: 10,
                            mainAxisSpacing: 10),
                        itemCount:  specialist['content'].length > 8
                            ? (isAllCategory
                                ? specialist['content'].length //Full length of the list
                                : (isMobile(context) ? 8 : 12))
                            : specialist['content'].length,
                        itemBuilder: (BuildContext context, int i) {
                          return GestureDetector(
                            onTap: () => Navigator.push(context, CustomRightPageRoute(page: DoctorsDisplayPage(
                                searchType: "first",
                                searchQuery: specialist['content'][i]['name'].toString(),
                            ...
                            child: Column(
                              ...
                              children: [
                                Image.network(
                                  isEmptyOrNull(specialist['content'][i]['img']) ? CATEGORY_DEFAULT_IMAGE : "${specialist['content'][i]['img']}",
                                  fit: BoxFit.fill,
                                  height: imgDimension,
                                  width: imgDimension,
                                ),
                                Padding(
                                  ...
                                  child: Text(
                                      isEmptyOrNull(specialist['content'][i]['name']) ? "Specials" :  "${specialist['content'][i]['name']}",
                    ...
                    mediumCustomSizedBox(context),
                    mediumCustomSizedBox(context),
                    //See all departmention Button
                    if (specialist['content'].length  > 8)
                    GestureDetector(
                      onTap: () => setState(() {
              ...
              /*-------start of all specialisations -------*/
              if(department['isempty'] == false) Container(
                margin: EdgeInsets.symmetric(
                    horizontal: kDefaultScreenPaddingHorizontal(context),
                    vertical: kDefaultScreenPaddingVertical(context)),
                child: Column(
                  ...
                  children: [
                    ...
                    GridView.builder(
                        ...
                        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                            ...
                            crossAxisSpacing: 10,
                            mainAxisSpacing: 10),
                        itemCount: department['content'].length,
                        itemBuilder: (BuildContext context, int i) {
                          return GestureDetector(
                            onTap: () => Navigator.push(context, CustomRightPageRoute(page: DoctorsDisplayPage(
                                searchType: "default",
                                searchQuery: department['content'][i]['name'].toString(),
                                doctorSpecialist: department['content'][i]['id'].toString(),
                                ), routeName: doctordisplay)),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.center,
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Image.network(
                                  isEmptyOrNull(department['content'][i]['img']) ? DEPT_DEFAULT_IMG : "${department['content'][i]['img']}",
                                  fit: BoxFit.fill,
                                  height: imgDimension,
                                  width: imgDimension,
                                ),
                                Padding(
                                  padding: EdgeInsets.only(
                                      top: isMobile(context) ? 4 : 7),
                                  child: Text(
                                    isEmptyOrNull(department['content'][i]['name']) ? DEPT_DEFAULT_IMG : "${department['content'][i]['name']}",
                                      textAlign: TextAlign.center,
                                      maxLines: 2,
                                      overflow: TextOverflow.clip,
                                      style: smallTextStyle(context)),
