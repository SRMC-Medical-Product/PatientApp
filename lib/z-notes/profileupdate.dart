...
class _PersonalDataPageState extends State<PersonalDataPage> {
  ...
  //   ///TODO : Add permission setup
  //   final XFile?  _pickedFile = await _picker.pickImage(source: ImageSource.gallery);
  //   // if(pickedFile != null){
  //   //   setState(() {
  //   //     _profileFuture = _profileScreenApi.uploadProfilePicture(pickedFile.path);
  //   //   });
  //   // }
  //     try {
  //     setState(() {
 ...
 XFile? imageFile;
  ...
  @override
    ...
    _putProfileUpdate({required String name,required String dob, required String email,String? blood,String? gender,String? relation,String? profileImg }) async{
      return await _profileScreenApi.putProfile(context: context, name: name, dob: dob, email: email,blood: blood,gender: gender,relation: relation,profileImg: profileImg);
    }
                ...
                Map<dynamic , dynamic > userData = snapshot.data['profile'];
                 SchedulerBinding.instance!
                  .addPostFrameCallback((_) => setState(() {
                      ...
                      if(snapshot.data['profile']['relation'] != null){
                        relationDropDownValue = snapshot.data['profile']['relation'];
                      }
                      // if(snapshot.data['profile']['img'] != null){
                      //   _image = snapshot.data['profile']['img'];
                      // }
                      ...
                      width: isMobile(context) ? 140 : 180,
                         child: ClipRRect(
                           ...
                           child: imageFile != null ? Image.file(
                              ...
                              isEmptyOrNull(snapshot.data['profile']['profileImg']) ? PATIENT_DEFAULT_IMG : snapshot.data['profile']['profileImg'].toString(),
                              fit: BoxFit.cover,
                            ),
            ...
            borderRadius: BorderRadius.circular(9),
                    ...
                    onTap: ()async{
                      ...
                      _putProfileUpdate(
                        ...
                        profileImg: (imageFile != null) ? imageFile!.path : "" //(_image != null || _image != "null" || _image != "") ? _image.toString(): "",
                        );
                    }, 
